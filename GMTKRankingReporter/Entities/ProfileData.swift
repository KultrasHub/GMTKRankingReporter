...
GameProfile(id:11,name:"Fire And Dice",score:4507,hours:"17 hours",genre:"Puzzle Strategy",size:"HTML5",imageName:"FireAndDice_main",description:"Dice up the competition before you're slain.",extraImage:["FireAndDice_1","FireAndDice_2","FireAndDice_3","FireAndDice_4"],author:["Golen","Matojeje","ArticFqx","LuxxArt"],url:"https://golen.itch.io/fire-and-dice"),
